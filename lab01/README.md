...
Трансляция в стандарте 98 прошла успешно, так как код содержит только базовые возможности языка
![Трансляция и запуск](08/media/1.png)
...
Трансляция может быть выполнена только в стандарте 2011, как и говорит ошибка в консоли
![Трансляция и запуск](08/media/2.png)
...
Трансляция в стандарте 98 провалилась. Ошибка 'x does not name a type' - переменная x не объявляет тип.
![Трансляция не выполнена](08/media/3.png)

Трансляция возможна только в стандарте 2011
![Трансляция и запуск выполнены](08/media/4.png)
...
Трансляция в стандарте 98 не выполнена. Ошибка 'v must be initialized by constructor' - вектор v должен быть объявлен с помощью конструктора.
![Трансляция не выполнена](08/media/5.png)

Трансляция в стандарте 2011 возможна
![Трансляция выполнена](08/media/6.png)
...
Трансляция в стандарте 98 жалуется на то, что не может правильно распознать запись 1'000'000'000, из-за чего выкидывает самые разные ошибки. 
![Трансляция не выполнена](08/media/7.png)

В этот раз пришлось взять стандарт 2014 чтобы трансляция прошла успешно
![Трансляция выполнена](08/media/8.png)
...
![Трансляция не выполнена](08/media/9.png)

Повышаем стандарт до 2017 и трансляция проходит успешно
![Трансляция выполнена](08/media/10.png)