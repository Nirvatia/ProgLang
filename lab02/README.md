...
Пример оператора: `std::cout << "Hello";` (вызов оператора `<<`), `my_func()` (вызов функции).
...
Что делает код? Программа считывает 3 строки чисел, разделенных пробелами, и выводит сумму чисел в каждом столбце.
